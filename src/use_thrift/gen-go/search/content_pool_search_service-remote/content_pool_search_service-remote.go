...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string search(ContentRequest request)")
...
func main() {
	...
	client := search.NewContentPoolSearchServiceClientFactory(trans, protocolFactory)
	...
	case "search":
		...
		argvalue0 := search.NewContentRequest()
